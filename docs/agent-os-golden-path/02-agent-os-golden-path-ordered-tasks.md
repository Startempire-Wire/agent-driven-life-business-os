...
- Date: 2026-09-10 (iteration 15 — the wrapped app is inert without the operated service; DIY means the standalone components, not a license-only app)
...
## Findings and evidence limits (iterations 5–15)
