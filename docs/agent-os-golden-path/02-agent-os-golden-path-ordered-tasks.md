...
- Date: 2026-09-10 (iteration 17 — the app is tethered by nature to the operated cloud: agent-in-the-loop, agent computers, remote support; the support contract is architectural)
...
## Findings and evidence limits (iterations 5–17)
