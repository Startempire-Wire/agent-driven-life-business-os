...
- Date: 2026-09-10 (iteration 13 — client app as the customer-facing core product: quiet presence, CoS dashboard, embedded substrate)
...
## Findings and evidence limits (iterations 5–13)
