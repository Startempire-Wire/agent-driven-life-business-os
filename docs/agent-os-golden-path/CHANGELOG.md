...
- **Cross-product agent-operation parity audit added:** inventoried current API, CLI, operation-catalogue and no-CUA posture across Focusa, UIAI, Wirebot/W.I.N.S., extensions, Veragensia, public sales/setup surfaces and Golden Path scripts; no product is prematurely marked accepted.
