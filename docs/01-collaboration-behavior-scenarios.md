...
Use when changing the collaboration rules in AGENTS.md. Review the actual change,
not whether particular phrases survive. This is a review aid, not another authority
or a certification that a model will behave correctly.

- **Activity and permission:** “Not implementing” keeps discussion moving without
  starting code changes. “Good direction” is not blanket approval.
- **Scoped correction:** “Stop testing” stops testing, not the requested explanation.
  An explicit whole-mission halt stops the mission.
